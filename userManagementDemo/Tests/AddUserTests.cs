...
public class AddUserTests 
{
    ...
    [Test, Category("Add User")]
    [TestCase(TestName = "Verify user can able to add")]
    public async Task AddUser_Test()
    {
        ...
        await addUserPage.SaveTeamTembersAsync(Constants.ASSIGNROLE, Constants.FIRSTNAME, Constants.LASTNAME, Constants.EMAIL, Constants.USERNAME, Constants.PASSWORD, Constants.CONFIRMPASSWORD);

        await homePage.TeamMembersAsync();

        await addUserPage.searchUser(Constants.FIRSTNAME);
    }
